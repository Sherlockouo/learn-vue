!function (e) {
  ...
  function u(e, n) {
    for (var t = {}, r = [], o = 0; o < e.length; o++) {
      var i = e[o], u = n.base ? i[0] + n.base : i[0], s = t[u] || 0, l = "".concat(u, " ").concat(s);
      t[u] = s + 1;
  ...
  "use strict";
  t.r(n), n.default = t.p + "img/beauty.144d4136.jpg"
}, function (e, n, t) {
  var r = t(0), o = t(8);
  "string" == typeof (o = o.__esModule ? o.default : o) && (o = [[e.i, o, ""]]);
  var i = {insert: "head", singleton: !1};
  ...
  (n = t(1)(!1)).push([e.i, "body {\n  font-size: 90px;\n  color: rgba(112, 56, 208, 0.96);\n}\n", ""]), e.exports = n
}, function (e, n, t) {
  "use strict";
  t.r(n);
  var r = t(2), o = r.add, i = r.mul;
  console.log(o(1, 3)), console.log(i(1, 3)), console.log("peak"), console.log(23), console.log(1.88), t(3), t(7)
}]);